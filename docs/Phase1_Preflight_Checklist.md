...
| 2.4 | Trust strip Sequence F Option β intact: Cut $72M without layoffs — Royal Caribbean → Two kids / SFUSD parent through 2040 → Turned $33M losses into $9M profit — HelloFresh → Cambridge Physics PhD — built for hard problems. DOM order unchanged. **BLOCKING.** | |
