---
title: "Michael Turon for SFUSD Board of Education"
description: "Michael Turon, Data Scientist and SFUSD Parent, running for Board of Education November 3, 2026."
summary: "Michael Turon, Data Scientist and SFUSD Parent, running for Board of Education November 3, 2026."
date: 2026-05-12
lastmod: 2026-05-12
translationKey: "home"
schema_type: "WebPage"
...
<!--
  ...
  Home page hero copy is operator-credential-anchored (locked). The trust
  strip company names stay English; only the descriptors localize per the
  i18n keys vendor_savings, sfusd_parent, ebitda_swing, cambridge_phd.
  Financial figures NEVER change.

  Three-pillar order is LOCKED: Special Education -> Budget Discipline ->
  Teacher Retention. Pillar names localize via i18n keys pillar1/2/3.
-->

<!-- AI TRANSLATION INPUT: English body from content/_index.md -->
<!-- AI TRANSLATION OUTPUT: insert translated body here, preserving Markdown,
     all shortcodes, and the locked DOM order. -->
